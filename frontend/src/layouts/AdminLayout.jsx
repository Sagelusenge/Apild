import { CalendarDays, ClipboardList, FileClock, FileText, FolderKanban, HeartPulse, LayoutDashboard, ShieldCheck, UserRoundCog, Users } from 'lucide-react';
...
export default function AdminLayout() {
  ...
  const items = [
    ...
    { to: '/rh', label: 'Ressources humaines', icon: UserRoundCog },
