...
- `docs/DEPLOYMENT_RENDER_AIVEN.md` : déploiement actuel prévu, avec deux services Render et MySQL Aiven ;
- `docs/DEPLOYMENT_AWS.md` : ancienne option de déploiement intégral AWS, non utilisée pour le présent hébergement.
